package com.kaixin.mykey.zbar.decode;
...
import com.kaixin.mykey.zbar.camera.CameraManager;
import com.kaixin.mykey.R;
...
public class MainHandler extends Handler {
     ...
     * 真正负责扫描任务的核心线程
     */
    private final com.kaixin.mykey.zbar.decode.DecodeThread decodeThread;
    ...
    public MainHandler(CaptureActivity activity, CameraManager cameraManager) {
        ...
        // 启动扫描线程
        decodeThread = new com.kaixin.mykey.zbar.decode.DecodeThread(activity);
        decodeThread.start();
        state = State.SUCCESS;
